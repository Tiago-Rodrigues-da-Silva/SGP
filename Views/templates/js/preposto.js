...
function alterar(id) {
    ...
    document.getElementById("modal-id_preposto-altera").value = id;

    var nome = "nome" + id;
    nome = document.getElementById(nome).innerText;
    document.getElementById("modal-nome-altera").value = nome;
...
function excluir(id) {
    //função que abre a modal Altera e preenche com os dados a serem alterados
    document.getElementById("modal-id-reclamante-exclui").value = id;
